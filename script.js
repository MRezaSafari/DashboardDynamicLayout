...
function bindEvents() {
  ...
  document.querySelectorAll(".row_remove").forEach(function (button) {
    button.addEventListener("click", function (e) {
      ...
      if (confirm("Are you sure you want to remove this row?")) parent.remove();
    });
  });
...
function generateRowTemplate(value) {
  return `<div class="col-md-${value}"><div class="report__container"><a href="" class="col-settings"><span class="icon-settings"></span></a></div></div><div class="col-md-${
    12 - value
  }"><div class="report__container"><a href="" class="col-settings"><span class="icon-settings"></span></a></div></div>`;
}
...
function generateRow() {
  ...
  let columns = generateRowTemplate(+rowValue + 1);
